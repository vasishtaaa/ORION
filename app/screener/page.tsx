            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-8 pr-3 py-1.5 rounded-xl bg-[#0a0d14] border border-white/10 text-xs font-mono text-white focus:outline-none focus:border-[#00ff87]"
                />
              </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left font-mono text-xs">
                <thead className="bg-black/40 border-b border-white/10 text-[var(--text-muted)] uppercase text-[10px] tracking-wider">
                  <tr>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('ticker')}>
                      <div className="flex items-center gap-1.5">
                        <span>Ticker</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    </th>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('price')}>
                      <div className="flex items-center gap-1.5">
                        <span>LTP (₹)</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    </th>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('change_pct')}>
                      <div className="flex items-center gap-1.5">
                        <span>24h Change</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    </th>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('rsi')}>
                      <div className="flex items-center gap-1.5">
                        <span>RSI (14)</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    </th>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('quant_score')}>
                      <div className="flex items-center gap-1.5">
                        <span>Quant Score</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    </th>
                    <th className="p-3.5 sm:p-4">AI Signal</th>
                    <th className="p-3.5 sm:p-4 cursor-pointer hover:text-white" onClick={() => handleSort('volume')}>
                      <div className="flex items-center gap-1.5">
                        <span>Volume</span>
                        <ArrowUpDown className="w-3 h-3" />
                      </div>
                    ...
                    >
                      <td className="p-3.5 sm:p-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[10px] text-[var(--text-muted)] truncate max-w-[140px] sm:max-w-[180px]">
                            {item.name}
                          </span>
                        </div>
                      </td>
                      <td className="p-3.5 sm:p-4 font-bold text-white">₹{item.price.toFixed(2)}</td>
                      <td className="p-3.5 sm:p-4">
                      ...
                      <td className="p-3.5 sm:p-4 text-[var(--text-muted)]">{item.volume.toLocaleString()}</td>
